...
mimic_db = create_engine("mysql+mysqldb://mimic:"+'mimic'+"@adcom.mmzzhh.com/mimic_filtered_care_c")
...
df_gcs = pd.read_sql("SELECT * FROM gcs_tot_IDS", con=mimic_db)
...
df_po2 = pd.read_sql("SELECT * FROM SPO2_IDS", con=mimic_db)

df_list = [df_po2, df_arterial_ph, df_arterial_bp, df_bun, df_hemoglubin, df_plateC, df_gcs, df_hco3, df_hr, df_hematocrit, df_pottasium, df_respiratory, df_sodium, df_temp, df_wbc]
